...
<template>
    ...
    <div
        class="min-h-screen bg-white p-8 text-slate-900 print:p-4"
        :style="printStyles"
    >
        <header
            class="no-print mb-6 flex items-center justify-between border-b border-slate-200 pb-4"
        >
            <span class="text-sm text-slate-600">Print preview</span>
            <button
                type="button"
        ...
        <div class="mb-8 flex items-start gap-6 border-b border-slate-200 pb-6">
            <img
            ...
            <div>
                ...
                <p v-if="snap.notes" class="mt-2 text-sm text-slate-600">
                    {{ snap.notes }}
                </p>
            </div>
        </div>
        ...
        >
            <h2
                class="mb-4 border-b border-slate-200 pb-2 text-lg font-semibold"
                :style="{ color: 'var(--print-brand)' }"
            >
                Group {{ gi + 1 }}
            </h2>
